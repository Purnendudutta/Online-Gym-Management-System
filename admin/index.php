...
<html lang="en">
  <head>
    ...
    <!-- Font-icon css-->
    <link rel="icon" href="..\img\classes-details.png">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <marquee onMouseOver="this.stop()" style="color: #e92f33;" onMouseOut="this.start()"> Don't forget to visit <a target="_blank" href="https://github.com/Purnendudutta/">Github</a> Purnendu Dutta</marquee>
